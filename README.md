...
1. **analysis-ready outputs** for direct reproduction of the main statistics and figures, and  
2. a **documented GEE/geemap notebook** to improve transparency of the upstream Landsat processing workflow.
